...
/**
 * This class defines a generic specification class for all operators.
 *
 ...
 * s.t. we can use a unified interface to create operators from a factory interface <code>SqlOperatorFactory</code>
 *
 * <p>The generic methods for an operator is to provide methods to get the unique ID, the list of entity names (i.e. stream name
 * in <code>Tuple</code> or <code>Relation</code> name) of input variables , and the entity name of the output variable.
 *
 */
